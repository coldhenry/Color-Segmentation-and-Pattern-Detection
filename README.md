...
<img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/img2.png" alt="layout" width="200" /><img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/img3.png" alt="layout" width="200" />
<img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/img5.png" alt="layout" width="200" /><img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/img69.png" alt="layout" width="200" />
...
|    <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/1.png" alt="layout" width="200" />  |  (1) |
| ---- | ---: |
|   <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/2.png" alt="layout" width="200" />    |  (2) |
|   <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/3.png" alt="layout" width="160" />  |  (3) |

Note that the symbol <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/3_1.png" alt="layout" width="60" />  refers to the value one if the category is k.
...
|  <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/4.png" alt="layout" width="160" />    |  (4) |
| :--- | ---: |
|  <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/5.png" alt="layout" width="200" />     |  (5) |

#### B.  Means

   Mean of each category is derived by the following equations:

|   <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/6.png" alt="layout" width="200" />    |  (6) |
| ---- | ---: |

#### C. Covariance

|   <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/7.png" alt="layout" width="200" />    |  (7) |
| ---- | ---: |
...
| <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/8.png" alt="layout" width="200" />      |  (8) |
| ---- | ---: |
|  <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/9.png" alt="layout" width="120" />     |  (9) |

  Or this could also be derived in the log-likelihood form:

|<img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/10.png" alt="layout" width="200" />      | (10) |
| ---- | ---: |
| <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/11.png" alt="layout" width="120" />      | (11) |

   Use the classifier to go through each data point, and use the following condition to build up the binary mask:

For each point, 

|  <img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/12.png" alt="layout" width="200" />     | (12) |
| ---- | ---: |
...
<img src="https://github.com/coldhenry/Color-Segmentation-and-Pattern-Detection/blob/master/pic/13.png" alt="layout" width="640" />
